    ...
    TrsDataSyncHelper trsDataSyncHelper)
{
    public async Task ExecuteAsync(bool dryRun, CancellationToken cancellationToken)
    {
        ...
        //// ea96655a-8e43-eb11-a812-0022489c571f
        ////var contactFilter = new FilterExpression();
        ////contactFilter.AddCondition(Contact.PrimaryIdAttribute, ConditionOperator.Equal, Guid.Parse("695e1206-4540-eb11-a813-000d3ab39307"));
        ...
        while (true)
        {
            ...
            if (result.MoreRecords)
            {
                ////if (query.PageInfo.PageNumber > 20)
                ////{
                ////    break;
                ////}
