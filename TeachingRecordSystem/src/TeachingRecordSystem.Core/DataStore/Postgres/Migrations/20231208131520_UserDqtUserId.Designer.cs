...
namespace TeachingRecordSystem.Core.DataStore.Postgres.Migrations
{
    ...
    [Migration("20231208131520_UserDqtUserId")]
    partial class UserDqtUserId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.Qualification", b =>
                {
                    b.HasOne("TeachingRecordSystem.Core.DataStore.Postgres.Models.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_qualifications_created_by");

                    b.HasOne("TeachingRecordSystem.Core.DataStore.Postgres.Models.User", null)
                        .WithMany()
                        .HasForeignKey("DeletedByUserId")
                        .HasConstraintName("fk_qualifications_deleted_by");
                    ...
                    b.HasOne("TeachingRecordSystem.Core.DataStore.Postgres.Models.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_qualifications_updated_by");
                });
