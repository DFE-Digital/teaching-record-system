...
public class PersonMapping : IEntityTypeConfiguration<Person>
{
    public void Configure(EntityTypeBuilder<Person> builder)
    {
        ...
        builder.Property(p => p.Trn).HasDefaultValueSql("fn_generate_trn()").ValueGeneratedOnAdd().HasMaxLength(Person.TrnExactLength).IsFixedLength();
        ...
        builder.Property(p => p.EmailAddress).HasMaxLength(Person.EmailAddressMaxLength).UseCollation(Collations.CaseInsensitive);
