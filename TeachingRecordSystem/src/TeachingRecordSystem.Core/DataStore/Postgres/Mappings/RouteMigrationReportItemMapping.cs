...
public class RouteMigrationReportItemMapping : IEntityTypeConfiguration<RouteMigrationReportItem>
{
    public void Configure(EntityTypeBuilder<RouteMigrationReportItem> builder)
    {
        ...
        builder.Property(r => r.DqtIttSubject1Name).HasMaxLength(250);
        builder.Property(r => r.DqtIttSubject1Value).HasMaxLength(20);
        builder.Property(r => r.DqtIttSubject2Name).HasMaxLength(250);
        builder.Property(r => r.DqtIttSubject2Value).HasMaxLength(20);
        builder.Property(r => r.DqtIttSubject3Name).HasMaxLength(250);
        builder.Property(r => r.DqtIttSubject3Value).HasMaxLength(20);
        ...
        builder.Property(r => r.TrainingSubject1Name).HasMaxLength(200);
        builder.Property(r => r.TrainingSubject1Reference).HasMaxLength(10);
        builder.Property(r => r.TrainingSubject2Name).HasMaxLength(200);
        builder.Property(r => r.TrainingSubject2Reference).HasMaxLength(10);
        builder.Property(r => r.TrainingSubject3Name).HasMaxLength(200);
        builder.Property(r => r.TrainingSubject3Reference).HasMaxLength(10);
