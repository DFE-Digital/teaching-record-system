...
public class InductionExemptionReasonMapping : IEntityTypeConfiguration<InductionExemptionReason>
{
    public void Configure(EntityTypeBuilder<InductionExemptionReason> builder)
    {
        ...
        builder.HasData(
            ...
            new InductionExemptionReason { InductionExemptionReasonId = new("4c97e211-10d2-4c63-8da9-b0fcebe7f2f9"), Name = "Overseas Trained Teacher", IsActive = true, RouteImplicitExemption = true },
            ...
            new InductionExemptionReason { InductionExemptionReasonId = InductionExemptionReason.QtlsId, Name = "Exempt through QTLS status provided they maintain membership of The Society of Education and Training", IsActive = true, RouteImplicitExemption = false });
    }
}
