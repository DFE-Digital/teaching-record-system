...
public class InductionExemptionReasonMapping : IEntityTypeConfiguration<InductionExemptionReason>
{
    public void Configure(EntityTypeBuilder<InductionExemptionReason> builder)
    {
        ...
        builder.HasData(
            ...
            new InductionExemptionReason { InductionExemptionReasonId = InductionExemptionReason.RegisteredTeacherWithAtLeast2YearsFullTimeTeachingExperienceId, Name = "Registered teacher with at least 2 years full-time teaching experience", IsActive = true, RouteImplicitExemption = false, RouteOnlyExemption = false },
