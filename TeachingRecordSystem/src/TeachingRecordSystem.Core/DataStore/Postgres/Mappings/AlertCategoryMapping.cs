...
public class AlertCategoryMapping : IEntityTypeConfiguration<AlertCategory>
{
    public void Configure(EntityTypeBuilder<AlertCategory> builder)
    {
        ...
        builder.HasData(
            new AlertCategory { AlertCategoryId = Guid.Parse("ee78d44d-abf8-44a9-b22b-87a821f8d3c9"), Name = "European Economic Area (EEA) decision", DisplayOrder = 1 },
            ...
            new AlertCategory { AlertCategoryId = Guid.Parse("b2b19019-b165-47a3-8745-3297ff152581"), Name = "Secretary of State decision", DisplayOrder = 7 },
            new AlertCategory { AlertCategoryId = Guid.Parse("e8a9ee91-bf7f-4f70-bc66-a644d522384e"), Name = "Disclosure and Barring Service (DBS) restriction", DisplayOrder = 8 },
