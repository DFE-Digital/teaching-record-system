...
public class UpdateIntegrationTransactionRecordHandler : ICrmTransactionalQueryHandler<UpdateIntegrationTransactionRecordQuery, bool>
{
    public Func<bool> AppendQuery(UpdateIntegrationTransactionRecordQuery query, RequestBuilder requestBuilder)
    {
