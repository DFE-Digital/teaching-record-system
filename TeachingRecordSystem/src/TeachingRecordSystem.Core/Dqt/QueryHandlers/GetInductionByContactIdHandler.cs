...
public class GetInductionByContactIdHandler : ICrmQueryHandler<GetInductionByContactIdQuery, InductionRecord>
{
    public async Task<InductionRecord> Execute(GetInductionByContactIdQuery getInductionQuery, IOrganizationServiceAsync organizationService)
    {
