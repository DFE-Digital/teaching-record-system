...
public class CreateHeQualificationHandler : ICrmTransactionalQueryHandler<CreateHeQualificationQuery, Guid>
{
    public Func<Guid> AppendQuery(CreateHeQualificationQuery query, RequestBuilder requestBuilder)
    {
