...
public class UpdateIntegrationTransactionHandler : ICrmTransactionalQueryHandler<UpdateIntegrationTransactionQuery, bool>
{
    public Func<bool> AppendQuery(UpdateIntegrationTransactionQuery query, RequestBuilder requestBuilder)
    {
