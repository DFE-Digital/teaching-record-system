...
public class FindActiveOrganisationsByOrgNumberHandler : ICrmQueryHandler<FindActiveOrganisationsByOrgNumberQuery, Account[]>
{
    public async Task<Account[]> ExecuteAsync(FindActiveOrganisationsByOrgNumberQuery query, IOrganizationServiceAsync organizationService)
    {
