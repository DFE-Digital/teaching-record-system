...
public class CreateInitialTeacherTrainingHandler : ICrmTransactionalQueryHandler<CreateInitialTeacherTrainingQuery, Guid>
{
    public Func<Guid> AppendQuery(CreateInitialTeacherTrainingQuery query, RequestBuilder requestBuilder)
    {
