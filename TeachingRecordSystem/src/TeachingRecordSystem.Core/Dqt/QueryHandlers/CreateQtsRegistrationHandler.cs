...
public class CreateQtsRegistrationHandler : ICrmTransactionalQueryHandler<CreateQtsRegistrationQuery, Guid>
{
    public Func<Guid> AppendQuery(CreateQtsRegistrationQuery query, RequestBuilder requestBuilder)
    {
