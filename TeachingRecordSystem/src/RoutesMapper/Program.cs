...
async IAsyncEnumerable<TrsDataSyncHelper.IttQtsMapResult[]> MapAsync()
{
    ...
    ////]);
    ////contactFilter.AddCondition(Contact.PrimaryIdAttribute, ConditionOperator.Equal, Guid.Parse("05106ad2-6e6e-e411-9829-005056822390"));
    ...
    ////contactFilter.AddCondition(Contact.PrimaryIdAttribute, ConditionOperator.Equal, Guid.Parse("2cbbe3f2-05af-e311-b8ed-005056822391"));
