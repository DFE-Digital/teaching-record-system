...
/// </summary>
public class LegacyRoutesViewAuthorizationHandler : AuthorizationHandler<RoutesViewRequirement>
{
    protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, RoutesViewRequirement requirement)
    {
        ...
        // The Qualifications tab (now Routes and qualifications) was previously visible to all users, so if the user hasn't been migrated yet,
