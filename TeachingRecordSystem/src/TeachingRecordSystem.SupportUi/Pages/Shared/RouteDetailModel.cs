...
public class RouteDetailModel()
{
    ...
    public FieldRequirement HoldsFromRequired => QuestionDriverHelper.FieldRequired(RouteToProfessionalStatusType.HoldsFromRequired, Status.GetHoldsFromDateRequirement());
