...
public partial class TrsLinkGenerator
{
    ...
    public string RouteAddPage(RoutePage page, Guid personId, JourneyInstanceId journeyInstanceId) =>
        page switch
        {
            RoutePage.Route => RouteAddRoute(personId, journeyInstanceId),
            RoutePage.Status => RouteAddStatus(personId, journeyInstanceId),
            RoutePage.StartAndEndDate => RouteAddStartAndEndDate(personId, journeyInstanceId),
            RoutePage.HoldsFrom => RouteAddHoldsFrom(personId, journeyInstanceId),
            RoutePage.InductionExemption => RouteAddInductionExemption(personId, journeyInstanceId),
            RoutePage.TrainingProvider => RouteAddTrainingProvider(personId, journeyInstanceId),
            RoutePage.DegreeType => RouteAddDegreeType(personId, journeyInstanceId),
            RoutePage.Country => RouteAddCountry(personId, journeyInstanceId),
            RoutePage.AgeRangeSpecialism => RouteAddAgeRangeSpecialism(personId, journeyInstanceId),
            RoutePage.SubjectSpecialisms => RouteAddSubjectSpecialisms(personId, journeyInstanceId),
            RoutePage.ChangeReason => RouteAddChangeReason(personId, journeyInstanceId),
            RoutePage.CheckYourAnswers => RouteAddCheckYourAnswers(personId, journeyInstanceId),
            _ => throw new ArgumentOutOfRangeException($"{nameof(RoutePage)}: {page.ToString()}")
        };

    public string RouteEditPage(RoutePage page, Guid qualificationId, JourneyInstanceId journeyInstanceId) =>
        page switch
        {
            RoutePage.Route => RouteEditRoute(qualificationId, journeyInstanceId),
            RoutePage.Status => RouteEditStatus(qualificationId, journeyInstanceId),
            RoutePage.StartAndEndDate => RouteEditStartAndEndDate(qualificationId, journeyInstanceId),
            RoutePage.HoldsFrom => RouteEditHoldsFrom(qualificationId, journeyInstanceId),
            RoutePage.InductionExemption => RouteEditInductionExemption(qualificationId, journeyInstanceId),
            RoutePage.TrainingProvider => RouteEditTrainingProvider(qualificationId, journeyInstanceId),
            RoutePage.DegreeType => RouteEditDegreeType(qualificationId, journeyInstanceId),
            RoutePage.Country => RouteEditCountry(qualificationId, journeyInstanceId),
            RoutePage.AgeRangeSpecialism => RouteEditAgeRangeSpecialism(qualificationId, journeyInstanceId),
            RoutePage.SubjectSpecialisms => RouteEditSubjectSpecialisms(qualificationId, journeyInstanceId),
            RoutePage.ChangeReason => RouteEditChangeReason(qualificationId, journeyInstanceId),
            RoutePage.CheckYourAnswers => RouteEditCheckYourAnswers(qualificationId, journeyInstanceId),
            _ => throw new ArgumentOutOfRangeException($"{nameof(RoutePage)}: {page.ToString()}")
        };
}
