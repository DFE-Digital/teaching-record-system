...
public partial class TrsLinkGenerator
{
    ...
    public string RouteChangeReason(Guid qualificationId, JourneyInstanceId? journeyInstanceId) =>
        GetRequiredPathByPage("/RoutesToProfessionalStatus/EditRoute/ChangeReason", routeValues: new { qualificationId }, journeyInstanceId: journeyInstanceId);
