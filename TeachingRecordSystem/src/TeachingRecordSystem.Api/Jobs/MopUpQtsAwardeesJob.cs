...
public class MopUpQtsAwardeesJob
{
    ...
    {
        var awardedToUtc = new DateOnly(2023, 7, 21).AddDays(-_batchSendQtsAwardedEmailsJobOptions.EmailDelayDays).ToDateTime();

        var executed = _clock.UtcNow;
        var startDate = _batchSendQtsAwardedEmailsJobOptions.InitialLastAwardedToUtc;
