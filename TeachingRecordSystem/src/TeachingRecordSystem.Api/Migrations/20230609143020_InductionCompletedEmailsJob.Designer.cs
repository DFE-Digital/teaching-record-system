...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.EntityChangesJournal", b =>
                {
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.Event", b =>
                {
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.EytsAwardedEmailsJob", b =>
                {
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.EytsAwardedEmailsJobItem", b =>
                {
                    b.Property<Guid>("EytsAwardedEmailsJobId")
                        .HasColumnType("uuid")
                        .HasColumnName("eyts_awarded_emails_job_id");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.InductionCompletedEmailsJob", b =>
                {
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.InductionCompletedEmailsJobItem", b =>
                {
                    b.Property<Guid>("InductionCompletedEmailsJobId")
                        .HasColumnType("uuid")
                        .HasColumnName("induction_completed_emails_job_id");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.InternationalQtsAwardedEmailsJob", b =>
                {
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.InternationalQtsAwardedEmailsJobItem", b =>
                {
                    b.Property<Guid>("InternationalQtsAwardedEmailsJobId")
                        .HasColumnType("uuid")
                        .HasColumnName("international_qts_awarded_emails_job_id");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.QtsAwardedEmailsJob", b =>
                {
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.QtsAwardedEmailsJobItem", b =>
                {
                    b.Property<Guid>("QtsAwardedEmailsJobId")
                        .HasColumnType("uuid")
                        .HasColumnName("qts_awarded_emails_job_id");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.TrnRequest", b =>
                {
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.EytsAwardedEmailsJobItem", b =>
                {
                    b.HasOne("TeachingRecordSystem.Api.DataStore.Sql.Models.EytsAwardedEmailsJob", "EytsAwardedEmailsJob")
                        .WithMany("JobItems")
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.InductionCompletedEmailsJobItem", b =>
                {
                    b.HasOne("TeachingRecordSystem.Api.DataStore.Sql.Models.InductionCompletedEmailsJob", "InductionCompletedEmailsJob")
                        .WithMany("JobItems")
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.InternationalQtsAwardedEmailsJobItem", b =>
                {
                    b.HasOne("TeachingRecordSystem.Api.DataStore.Sql.Models.InternationalQtsAwardedEmailsJob", "InternationalQtsAwardedEmailsJob")
                        .WithMany("JobItems")
            ...
            modelBuilder.Entity("TeachingRecordSystem.Api.DataStore.Sql.Models.QtsAwardedEmailsJobItem", b =>
                {
                    b.HasOne("TeachingRecordSystem.Api.DataStore.Sql.Models.QtsAwardedEmailsJob", "QtsAwardedEmailsJob")
                        .WithMany("JobItems")
