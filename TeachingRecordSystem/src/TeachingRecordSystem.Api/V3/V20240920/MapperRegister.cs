...
public class MapperRegister : IRegister
{
    ...
    {
        config.NewConfig<Implementation.Dtos.AlertCategory, AlertCategory>();
        config.NewConfig<Implementation.Dtos.AlertType, AlertType>();
        config.NewConfig<Implementation.Dtos.Alert, Alert>();
