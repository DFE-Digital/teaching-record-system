...
public partial class ApiMapper
{
    public GetPersonResponse MapGetPersonResponse(GetPersonResult source) =>
        new()
        {
            ...
            Qts = source.Qts is { } qts ? new GetPersonResponseQts { Awarded = qts.HoldsFrom, StatusDescription = qts.StatusDescription } : null,
    ...
    public Core.Models.InductionStatus MapInductionStatus(V20250203Dtos.InductionStatus source) =>
        (Core.Models.InductionStatus)(int)source;
