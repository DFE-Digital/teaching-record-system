...
public class MapperRegister : IRegister
{
    ...
    {
        config.NewConfig<Implementation.Dtos.Alert, AlertInfo>()
            .MapWith(src => new AlertInfo
            {
                AlertType = AlertType.Prohibition,
                DqtSanctionCode = src.AlertType.DqtSanctionCode!,
                StartDate = src.StartDate,
                EndDate = src.EndDate
            });

        config.NewConfig<Implementation.Dtos.NameInfo, NameInfo>();
        config.NewConfig<Implementation.Dtos.SanctionInfo, SanctionInfo>();
