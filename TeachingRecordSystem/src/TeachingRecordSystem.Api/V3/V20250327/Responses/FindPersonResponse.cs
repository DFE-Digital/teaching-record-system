...
public record FindPersonResponseResult
{
    ...
    public static FindPersonResponseResult FromModel(FindPersonsResultItem r) => new()
    {
        ...
        Qts = r.Qts is null ? null : new QtsInfo { Awarded = r.Qts.HoldsFrom, StatusDescription = r.Qts.StatusDescription, AwardedOrApprovedCount = r.Qts.AwardedOrApprovedCount },
