...
public sealed record ApiError(int ErrorCode, string Title, string? Detail = null)
{
    ...
    public static ApiError InTrainingProfessionalStatusNotPermittedForRouteType(Guid routeTypeId) =>
        new(ErrorCodes.InTrainingProfessionalStatusNotPermittedForRouteType, "In training professional status not permitted for route type.", $"Route type: '{routeTypeId}'");

    public static ApiError UnderAssessmentOnlyPermittedForRouteType(Guid routeTypeId) =>
        new(ErrorCodes.UnderAssessmentOnlyPermittedForRouteType, "Under assessment only permitted for route type.", $"Route type: '{routeTypeId}'");
