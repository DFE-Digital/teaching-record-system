...
using TeachingRecordSystem.Api.V1.Handlers;
    ...
    public void Given_a_contact_with_initial_teacher_training_the_details_are_mapped()
    {
        ...
        var contact = new Contact
        {
            ...
            Attributes =
            {
                ...
                { $"{prefix}.{subjectPrefix}1.{dfeta_ittsubject.PrimaryIdAttribute}",
                    new AliasedValue(dfeta_ittsubject.EntityLogicalName, dfeta_ittsubject.PrimaryIdAttribute, Guid.NewGuid()) },
                ...
                { $"{prefix}.{subjectPrefix}2.{dfeta_ittsubject.PrimaryIdAttribute}",
                    new AliasedValue(dfeta_ittsubject.EntityLogicalName, dfeta_ittsubject.PrimaryIdAttribute, Guid.NewGuid()) },
