...
public class CreateTrnRequestDqtTests : OperationTestBase, IAsyncLifetime
{
    public CreateTrnRequestDqtTests(OperationTestFixture operationTestFixture) : base(operationTestFixture)
    {
