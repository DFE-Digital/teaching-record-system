...
public class PersonTests
{
    ...
    public void SetCpdInductionStatus_SetsOverallStatusAndOutsEvent(InductionStatus status)
    {
        ...
        // Assert
        Assert.Equal(status, person.CpdInductionStatus);
    ...
    public void SetWelshInductionStatus_StatusIsAlreadySetToHigherPriorityStatus_DoesNotChangeStatus(bool passed, InductionStatus currentStatus)
    {
        // Arrange
        var person = CreatePerson();
    ...
    [InlineData(InductionStatus.RequiredToComplete)]
    [InlineData(InductionStatus.InProgress)]
    public void SetWelshInductionStatus_PassedAndStatusIsAtLowerPriorityStatus_UpdatesStatusAndReturnsTrue(InductionStatus currentStatus)
    {
        // Arrange
        var person = CreatePerson();
