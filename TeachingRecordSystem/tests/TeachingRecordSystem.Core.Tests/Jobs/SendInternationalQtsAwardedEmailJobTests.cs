...
public class SendInternationalQtsAwardedEmailJobTests : InternationalQtsAwardedEmailJobTestBase
{
    ...
    public Task Execute_WhenCalled_GetsTrnTokenSendsEmailAddsEventAndUpdatesDatabase() =>
        DbFixture.WithDbContextAsync(async dbContext =>
        {
            ...
            // Act
            await job.ExecuteAsync(internationalQtsAwardedEmailsJobId, personId);
            ...
            var updatedJobItem = await dbContext.InternationalQtsAwardedEmailsJobItems.SingleOrDefaultAsync(i =>
                i.InternationalQtsAwardedEmailsJobId == internationalQtsAwardedEmailsJobId && i.PersonId == personId);
            ...
            var emailSentEvent = events
                ...
                .Where(e => e!.InternationalQtsAwardedEmailsJobId == internationalQtsAwardedEmailsJobId &&
                            e.PersonId == personId)
                .SingleOrDefault();
