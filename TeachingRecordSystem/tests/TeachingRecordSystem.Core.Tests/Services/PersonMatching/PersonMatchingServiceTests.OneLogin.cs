...
public partial class PersonMatchingServiceTests
{
    ...
    public static TheoryData<NameArgumentOption, DateOfBirthArgumentOption, NationalInsuranceNumberArgumentOption, TrnArgumentOption, bool, IEnumerable<OneLoginUserMatchedAttribute>?> MatchOneLoginUserData { get; } = new()
    {
        // *** Match cases ***
