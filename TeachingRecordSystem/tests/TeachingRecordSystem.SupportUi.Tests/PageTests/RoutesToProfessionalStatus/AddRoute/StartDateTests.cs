...
public class StartDateTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task Get_ShowsPreviouslyStoredEntry()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/routes/add/start-date?personId={person.PersonId}&{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Post_WhenTrainingStartDateIsEntered_SavesDateAndRedirectsToNextPage()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, $"/routes/add/start-date?personId={person.PersonId}&{journeyInstance.GetUniqueIdQueryParameter()}")
        {
        ...
        Assert.Equal($"/routes/add/end-date?personId={person.PersonId}&{journeyInstance.GetUniqueIdQueryParameter()}", response.Headers.Location?.OriginalString);
    ...
    public async Task Post_StartDateAfterEndDate_RedirectToEndDatePage()
    {
        ...
        // Assert
        Assert.Equal(StatusCodes.Status302Found, (int)response.StatusCode);
        var expected = $"/routes/add/end-date?personId={person.PersonId}&{journeyInstance.GetUniqueIdQueryParameter()}";
        Assert.StartsWith($"/routes/add/end-date?personId={person.PersonId}&{journeyInstance.GetUniqueIdQueryParameter()}", response.Headers.Location?.OriginalString);
    }
