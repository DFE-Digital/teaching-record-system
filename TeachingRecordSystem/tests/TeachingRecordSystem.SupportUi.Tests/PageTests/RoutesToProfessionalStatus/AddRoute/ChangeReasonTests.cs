...
public class ChangeReasonTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task Get_WithPreviouslyStoredChoices_ShowsChoices()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/route/add/change-reason?personId={person.PersonId}&{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Post_SetValidChangeReasonDetails_PersistsDetailsAndRedirects()
    {
        ...
        var postRequest = new HttpRequestMessage(HttpMethod.Post, $"/route/add/change-reason?personId={person.PersonId}&{journeyInstance.GetUniqueIdQueryParameter()}")
        {
    ...
    public async Task Post_AdditionalDetailYes_NoDetailAdded_ReturnsError()
    {
        ...
        {
            Content = new MultipartFormDataContentBuilder()
                .Add("ChangeReason", ChangeReasonOption.AnotherReason)
                .Add("HasAdditionalReasonDetail", true)
                .Add("UploadEvidence", false)
                .Build()
        };
    ...
    public async Task Cancel_deletesJourneyAndRedirectsToExpectedPage()
    {
        ...
        var route = (await ReferenceDataCache.GetRouteToProfessionalStatusTypesAsync())
            .Where(r => r.TrainingStartAndEndDatesRequired == FieldRequirement.Mandatory)
            .RandomOne();
        var status = ProfessionalStatusStatusRegistry.All
            .Where(s => s.TrainingStartAndEndDateRequired == FieldRequirement.Mandatory)
            .RandomOne()
            .Value;
        var person = await TestData.CreatePersonAsync(p => p
            .WithRouteToProfessionalStatus(r => r
