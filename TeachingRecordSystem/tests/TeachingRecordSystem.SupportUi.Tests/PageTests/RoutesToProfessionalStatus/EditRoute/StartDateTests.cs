...
public class StartDateTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task Post_WhenTrainingStartDateIsEntered_SavesDateAndRedirectsToDetail()
    {
        ...
        var status = ProfessionalStatusStatusRegistry.All
            .Where(s => s.TrainingStartDateRequired == FieldRequirement.Mandatory && s.TrainingEndDateRequired == FieldRequirement.Mandatory && s.AwardDateRequired == FieldRequirement.NotApplicable)
            .RandomOne()
            .Value;
