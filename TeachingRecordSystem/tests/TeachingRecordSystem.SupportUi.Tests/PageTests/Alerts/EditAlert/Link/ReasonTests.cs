...
public class ReasonTests(HostFixture hostFixture) : LinkTestBase(hostFixture), IAsyncLifetime
{
    ...
    public async Task Get_UserDoesNotHavePermission_ReturnsForbidden(string? role)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/alerts/{alert.AlertId}/link/reason?{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Get_WithAlertIdForNonExistentAlert_ReturnsNotFound()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/alerts/{alertId}/link/reason?{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Post_WithAlertIdForNonExistentAlert_ReturnsNotFound()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, $"/alerts/{alertId}/link/reason?{journeyInstance.GetUniqueIdQueryParameter()}")
        {
            Content = CreateMinimumValidPostContent()
        };
    ...
    public async Task PersonIsDeactivated_ReturnsBadRequest(HttpMethod httpMethod)
    {
        ...
        var request = new HttpRequestMessage(httpMethod, $"/alerts/{alert.AlertId}/link/reason?{journeyInstance.GetUniqueIdQueryParameter()}");
