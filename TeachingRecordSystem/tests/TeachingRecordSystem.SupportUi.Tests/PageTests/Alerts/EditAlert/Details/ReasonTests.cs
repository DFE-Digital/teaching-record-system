...
public class ReasonTests(HostFixture hostFixture) : DetailsTestBase(hostFixture)
{
    ...
    public async Task Get_UserDoesNotHavePermission_ReturnsForbidden(string? role)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/alerts/{alert.AlertId}/detailsreason?{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Get_WithAlertIdForNonExistentAlert_ReturnsNotFound()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/alerts/{alertId}/detailsreason?{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Post_UserDoesNotHavePermission_ReturnsForbidden(string? role)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, $"/alerts/{alert.AlertId}/detailsreason?{journeyInstance.GetUniqueIdQueryParameter()}")
        {
    ...
    public async Task Post_Cancel_DeletesJourneyAndRedirects()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, $"/alerts/{alert.AlertId}/detailsreason/cancel?{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task PersonIsDeactivated_ReturnsBadRequest(HttpMethod httpMethod)
    {
        ...
        var request = new HttpRequestMessage(httpMethod, $"/alerts/{alert.AlertId}/detailsreason?{journeyInstance.GetUniqueIdQueryParameter()}");
