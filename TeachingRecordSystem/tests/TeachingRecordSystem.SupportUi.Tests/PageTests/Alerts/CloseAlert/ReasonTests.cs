...
public class ReasonTests(HostFixture hostFixture) : CloseAlertTestBase(hostFixture), IAsyncLifetime
{
    ...
    public async Task Get_UserDoesNotHavePermission_ReturnsForbidden(string? role)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/alerts/{alert.AlertId}/close/reason?{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Get_WithAlertIdForNonExistentAlert_ReturnsNotFound()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/alerts/{alertId}/close/reason?{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Post_UserDoesNotHavePermission_ReturnsForbidden(string? role)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, $"/alerts/{alert.AlertId}/close/reason?{journeyInstance.GetUniqueIdQueryParameter()}")
        {
    ...
    public async Task Post_WithAlertIdForNonExistentAlert_ReturnsNotFound()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, $"/alerts/{alertId}/close/reason?{journeyInstance.GetUniqueIdQueryParameter()}");
    ...
    public async Task Post_ValidInputWithoutEvidenceFile_UpdatesStateAndRedirectsToCheckAnswersPage()
    {
        ...
        // Assert
        Assert.Equal(StatusCodes.Status302Found, (int)response.StatusCode);
        Assert.StartsWith($"/alerts/{alert.AlertId}/close/check-answers?{journeyInstance.GetUniqueIdQueryParameter()}", response.Headers.Location?.OriginalString);
    ...
    private static MultipartFormDataContentBuilder CreatePostContent(
        CloseAlertReasonOption? changeReason = null,
