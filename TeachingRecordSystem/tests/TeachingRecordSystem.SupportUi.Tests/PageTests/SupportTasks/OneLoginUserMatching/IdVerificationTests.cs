...
public class IdVerificationTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task Get_OrderListByReferenceId_OrdersList(SortDirection sortDirection)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/support-tasks/one-login-user-matching/id-verification?sortBy={OneLoginIdVerificationSupportTasksSortByOption.SupportTaskReference}&sortDirection={sortDirection}");
    ...
    public async Task Get_Search_ShowsMatchingResult(string search, string[] expected)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/support-tasks/one-login-user-matching/id-verification?Search={search}&sortBy={OneLoginIdVerificationSupportTasksSortByOption.Name}&sortDirection={SortDirection.Ascending}");
