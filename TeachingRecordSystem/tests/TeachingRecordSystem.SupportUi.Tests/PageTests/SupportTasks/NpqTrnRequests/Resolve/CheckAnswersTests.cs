...
public class CheckAnswersTests : NpqTrnRequestTestBase
{
    ...
    public async Task Post_UpdatingExistingRecord_UpdatesRecordUpdatesSupportTaskPublishesEventCompletesJourneyAndRedirects(PersonMatchedAttribute attribute)
    {
        ...
        AssertEx.HtmlDocumentHasFlashSuccess(
            nextPageDoc,
            $"TRN request for {StringExtensions.JoinNonEmpty(' ', matchedPerson.FirstName, matchedPerson.MiddleName, matchedPerson.LastName)} completed");
    ...
    public async Task Post_CreatingNewRecord_CreatesRecordUpdatesSupportTaskPublishesEventSendsEmailCompletesJourneyAndRedirects()
    {
        ...
        var (supportTask, _, matchedPersonIds) = await TestData.CreateNpqTrnRequestSupportTaskAsync(applicationUser.UserId, s =>
        {
