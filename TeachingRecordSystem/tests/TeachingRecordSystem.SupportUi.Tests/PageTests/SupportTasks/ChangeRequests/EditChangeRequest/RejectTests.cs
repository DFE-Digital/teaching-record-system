...
public class RejectTests(HostFixture hostFixture) : TestBase(hostFixture), IAsyncLifetime
{
    ...
    public async Task Get_WithSupportTaskReferenceForNonExistentSupportTask_ReturnsNotFound()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/support-tasks/change-requests/{nonExistentSupportTaskReference}/reject");
