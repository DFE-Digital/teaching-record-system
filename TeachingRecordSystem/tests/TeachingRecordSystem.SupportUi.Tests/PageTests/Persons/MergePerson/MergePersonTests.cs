        ...
        bool useNullValues)
    {
        ...
        var journeyInstance = await CreateJourneyInstanceAsync(
            ...
            new MergePersonStateBuilder()
                ...
                .WithPersonB(personB)
                .WithPrimaryPerson(personA)
                .WithFirstNameSource(PersonAttributeSource.TrnRequest)
                .WithMiddleNameSource(PersonAttributeSource.TrnRequest)
                .WithLastNameSource(PersonAttributeSource.TrnRequest)
                .WithDateOfBirthSource(PersonAttributeSource.TrnRequest)
                .WithEmailAddressSource(PersonAttributeSource.TrnRequest)
                .WithNationalInsuranceNumberSource(PersonAttributeSource.TrnRequest)
                .WithGenderSource(PersonAttributeSource.TrnRequest)
                .WithComments(null)
                .Build());
