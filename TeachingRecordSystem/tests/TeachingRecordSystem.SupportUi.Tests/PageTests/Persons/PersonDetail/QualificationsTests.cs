...
public class QualificationsTests(HostFixture hostFixture) : TestBase(hostFixture)
{
        ...
        string? endDateString)
    {
        ...
        Assert.Equal(startDate is not null ? startDate.Value.ToString(UiDefaults.DefaultDateOnlyDisplayFormat) : "None", mandatoryQualificationSummary.GetElementByTestId($"mq-start-date-{qualificationId}")!.TextContent);
        ...
        Assert.Equal(endDate is not null ? endDate.Value.ToString(UiDefaults.DefaultDateOnlyDisplayFormat) : "None", mandatoryQualificationSummary.GetElementByTestId($"mq-end-date-{qualificationId}")!.TextContent);
    }
}
