...
public class EditDetailsStateBuilder
{
    ...
    public EditDetailsState Build()
    {
        return new EditDetailsState
        {
            ...
            LastName = LastName,
            DateOfBirth = DateOfBirth,
            EmailAddress = new EditDetailsFieldState<EmailAddress>(EmailAddress, Core.EmailAddress.TryParse(EmailAddress, out var emailAddress) ? emailAddress : null),
            MobileNumber = new EditDetailsFieldState<MobileNumber>(MobileNumber, Core.MobileNumber.TryParse(MobileNumber, out var mobileNumber) ? mobileNumber : null),
            NationalInsuranceNumber = new EditDetailsFieldState<NationalInsuranceNumber>(NationalInsuranceNumber, Core.NationalInsuranceNumber.TryParse(NationalInsuranceNumber, out var nationalInsuranceNumber) ? nationalInsuranceNumber : null),
