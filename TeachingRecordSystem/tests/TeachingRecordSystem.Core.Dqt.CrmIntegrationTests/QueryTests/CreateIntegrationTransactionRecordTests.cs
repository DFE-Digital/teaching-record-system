...
//             .WithDqtInduction(inductionStatus: dfeta_InductionStatus.Pass, inductionExemptionReason: null, inductionPeriodStartDate: new DateOnly(2021, 01, 01), completedDate: new DateOnly(2022, 01, 01), inductionStartDate: new DateOnly(2021, 01, 01), inductionPeriodEndDate: new DateOnly(2022, 01, 01), appropriateBodyOrgId: establishment1.AccountId)
...
//         Assert.Equal(integrationTransactionId, createdIntegrationTransactionRecord.dfeta_IntegrationTransactionId.Id);
//         Assert.Equal(reference, createdIntegrationTransactionRecord.dfeta_id);
//         Assert.Equal(person.ContactId, createdIntegrationTransactionRecord.dfeta_PersonId.Id);
//         Assert.Equal(person.DqtInductions.First().InductionId, createdIntegrationTransactionRecord.dfeta_InductionId.Id);
