...
namespace TeachingRecordSystem.Core.DataStore.Postgres.Migrations
{
    ...
    [Migration("20260729112937_SupportTaskSourceApplicationUser")]
    partial class SupportTaskSourceApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.AuthzRegistrationToken", b =>
                {
                    ...
                    b.ToTable("authz_registration_tokens", (string)null);
                });
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.OneLoginUser", b =>
                {
                    ...
                    b.HasIndex("EmailAddress")
                        .HasDatabaseName("ix_one_login_users_email_address")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true);
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.Process", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("OneLoginUserSubjects")
                        .IsRequired()
                        .HasColumnType("text[]")
                    ...
                    b.PrimitiveCollection<List<string>>("SupportTaskReferences")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("support_task_references");
                    ...
                    b.HasIndex("OneLoginUserSubjects")
                        .HasDatabaseName("ix_processes_one_login_user_subjects")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true)
                        .HasAnnotation("Npgsql:IndexMethod", "GIN");
                    ...
                    b.HasIndex("SupportTaskReferences")
                        .HasDatabaseName("ix_processes_support_task_references")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true)
                        .HasAnnotation("Npgsql:IndexMethod", "GIN");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.ProcessEvent", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("SupportTaskReferences")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("support_task_references");
                    ...
                    b.HasIndex("SupportTaskReferences", "EventName")
                        .HasDatabaseName("ix_process_events_support_task_references_event_name")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true)
                        .HasAnnotation("Npgsql:IndexMethod", "GIN");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.SupportTask", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("SubjectNames")
                        .HasColumnType("varchar[]")
                        .HasColumnName("subject_names")
                        .UseCollation("case_insensitive");
                    ...
                    b.PrimitiveCollection<string[]>("ZendeskTickets")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar[]")
                        .HasColumnName("zendesk_tickets")
                    ...
                    b.HasIndex("SubjectEmailAddress", "SubjectNames")
                        .HasDatabaseName("ix_support_tasks_subject_email_address_subject_names")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true)
                        .HasAnnotation("Npgsql:IndexMethod", "GIN")
                        .HasAnnotation("Relational:Collation", new[] { "case_insensitive" });
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.SupportTaskNote", b =>
                {
                    b.Property<Guid>("SupportTaskNoteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("support_task_note_id");
                    ...
                    b.HasKey("SupportTaskNoteId")
                        .HasName("pk_support_task_notes");

                    b.HasIndex("SupportTaskReference")
                        .HasDatabaseName("ix_support_task_notes_support_task_reference")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true);

                    b.ToTable("support_task_notes", (string)null);
                });
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.TrnRequestMetadata", b =>
                {
                    ...
                    b.HasIndex("ApplicationUserId")
                        .HasDatabaseName("ix_trn_request_metadata_application_user_id")
                        .HasAnnotation("Npgsql:CreatedConcurrently", true);
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.WebhookMessage", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("FailedRequests")
                        .IsRequired()
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("RecordMatchingPolicy")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
                        .HasColumnName("record_matching_policy");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastSignedInUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_signed_in_utc");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.SupportTask", b =>
                {
                    b.HasOne("TeachingRecordSystem.Core.DataStore.Postgres.Models.User", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToUserId")
                        .HasConstraintName("fk_support_tasks_users_assigned_to_user_id");

                    b.HasOne("TeachingRecordSystem.Core.DataStore.Postgres.Models.User", "CompletedBy")
                        .WithMany()
                        .HasForeignKey("CompletedByUserId")
                        .HasConstraintName("fk_support_tasks_users_completed_by_user_id");
                    ...
                    b.HasOne("TeachingRecordSystem.Core.DataStore.Postgres.Models.ApplicationUser", "SourceApplicationUser")
                        .WithMany()
                        .HasForeignKey("SourceApplicationUserId")
                        .HasConstraintName("fk_support_tasks_application_users_source_application_user_id");
                    ...
                    b.Navigation("SourceApplicationUser");
            ...
            modelBuilder.Entity("TeachingRecordSystem.Core.DataStore.Postgres.Models.SupportTaskNote", b =>
                {
                    b.HasOne("TeachingRecordSystem.Core.DataStore.Postgres.Models.User", "CreatedBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_support_task_notes_users_created_by_user_id");

                    b.HasOne("TeachingRecordSystem.Core.DataStore.Postgres.Models.SupportTask", null)
                        .WithMany()
                        .HasForeignKey("SupportTaskReference")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_support_task_notes_support_tasks_support_task_reference");
