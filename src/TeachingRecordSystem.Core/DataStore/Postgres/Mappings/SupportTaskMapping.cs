...
public class SupportTaskMapping : IEntityTypeConfiguration<SupportTask>
{
    public void Configure(EntityTypeBuilder<SupportTask> builder)
    {
        ...
        builder.HasQueryFilter(SupportTask.QueryFilterNames.Deleted, q => EF.Property<DateTime?>(q, nameof(SupportTask.DeletedOn)) == null);
        ...
        builder
            ...
            .ConfigureAnalyticsSync(included: false);
        builder.HasIndex("SubjectEmailAddress", "SubjectNames")
            .HasMethod("GIN")
            .UseCollation(Collations.CaseInsensitive)
