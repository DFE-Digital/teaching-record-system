...
{
    extension(ProfessionalStatusStatus input)
    {
        public RouteToProfessionalStatusStatus ConvertToRouteToProfessionalStatusStatus()
        {
        ...
        public bool TryConvertToRouteToProfessionalStatusStatus(out RouteToProfessionalStatusStatus result)
        {
