...
/// <summary>
/// Back-fills <see cref="Process"/> and <see cref="ProcessEvent"/> records from the legacy DQT-era mandatory
/// qualification deactivated/imported/migrated events stored in the <c>events</c> table.
/// </summary>
/// <remarks>
...
/// </remarks>
public class BackfillMandatoryQualificationDqtProcessesJob(TrsDbContext dbContext)
{
    ...
    [
        typeof(LegacyEvents.MandatoryQualificationDqtDeactivatedEvent).Name,
        typeof(LegacyEvents.MandatoryQualificationDqtImportedEvent).Name,
        typeof(LegacyEvents.MandatoryQualificationMigratedEvent).Name
    ];
    ...
    {
        LegacyEvents.MandatoryQualificationDqtDeactivatedEvent e => (
            new MandatoryQualificationDqtDeactivatedEvent
            {
                EventId = e.EventId,
                PersonId = e.PersonId,
                MandatoryQualification = e.MandatoryQualification
            },
            ProcessType.MandatoryQualificationDeactivatingInDqt),

        LegacyEvents.MandatoryQualificationDqtImportedEvent e => (
        ...
        LegacyEvents.MandatoryQualificationMigratedEvent e => (
            new MandatoryQualificationMigratedEvent
            {
                EventId = e.EventId,
                PersonId = e.PersonId,
                MandatoryQualification = e.MandatoryQualification,
                Changes = (MandatoryQualificationMigratedEventChanges)(int)e.Changes
            },
