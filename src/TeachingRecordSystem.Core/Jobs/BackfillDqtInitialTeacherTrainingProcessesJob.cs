...
/// <summary>
/// Back-fills <see cref="Process"/> and <see cref="ProcessEvent"/> records from the legacy DQT-era initial teacher
/// training events stored in the <c>events</c> table.
/// </summary>
/// <remarks>
...
/// </remarks>
public class BackfillDqtInitialTeacherTrainingProcessesJob(TrsDbContext dbContext)
{
