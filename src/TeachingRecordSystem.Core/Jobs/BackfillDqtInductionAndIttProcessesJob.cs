...
/// <summary>
/// Back-fills <see cref="Process"/> and <see cref="ProcessEvent"/> records from the legacy DQT-era induction and
/// initial teacher training events stored in the <c>events</c> table.
/// </summary>
/// <remarks>
...
/// </remarks>
public class BackfillDqtInductionAndIttProcessesJob(TrsDbContext dbContext)
{
    ...
    [
        ...
        typeof(LegacyEvents.DqtInitialTeacherTrainingCreatedEvent).Name,
        typeof(LegacyEvents.DqtInitialTeacherTrainingUpdatedEvent).Name
    ];
    ...
    private static (IEvent Event, ProcessType ProcessType)? MapEvent(LegacyEvents.EventBase legacyEvent) => legacyEvent switch
    {
        ...
        LegacyEvents.DqtInitialTeacherTrainingCreatedEvent e => (
            new DqtInitialTeacherTrainingCreatedEvent
            {
                EventId = e.EventId,
                PersonId = e.PersonId,
                InitialTeacherTraining = e.InitialTeacherTraining
            },
            ProcessType.InitialTeacherTrainingCreatingInDqt),

        LegacyEvents.DqtInitialTeacherTrainingUpdatedEvent e => (
            new DqtInitialTeacherTrainingUpdatedEvent
            {
                EventId = e.EventId,
                PersonId = e.PersonId,
                InitialTeacherTraining = e.InitialTeacherTraining,
                OldInitialTeacherTraining = e.OldInitialTeacherTraining,
                Changes = (DqtInitialTeacherTrainingUpdatedEventChanges)(int)e.Changes
            },
