...
{
    public static FieldRequirement GetFieldRequirement(this EditRoutePage page, RouteToProfessionalStatusType route, RouteToProfessionalStatusStatus status)
    {
        return page switch
        {
    ...
    public static bool AppliesToRoute(this EditRoutePage page, RouteToProfessionalStatusType route, RouteToProfessionalStatusStatus status) =>
        page switch
        {
