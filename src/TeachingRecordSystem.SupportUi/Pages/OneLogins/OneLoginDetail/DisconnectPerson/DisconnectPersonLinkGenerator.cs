...
{
    public string Index(string oneLoginUserSubject, Guid personId, JourneyInstanceId? journeyInstanceId,
    ...
    public string Cancel(string oneLoginUserSubject, Guid personId, JourneyInstanceId journeyInstanceId) =>
    ...
    public string Verified(string oneLoginUserSubject, Guid personId, JourneyInstanceId journeyInstanceId, bool? fromCheckAnswers = null) =>
        linkGenerator.GetRequiredPathByPage("/OneLogins/OneLoginDetail/DisconnectPerson/Verified",
            routeValues: new { oneLoginUserSubject, personId, fromCheckAnswers }, journeyInstanceId: journeyInstanceId);

    public string VerifiedCancel(string oneLoginUserSubject, Guid personId, JourneyInstanceId journeyInstanceId) =>
        linkGenerator.GetRequiredPathByPage("/OneLogins/OneLoginDetail/DisconnectPerson/Verified", "cancel",
            routeValues: new { oneLoginUserSubject, personId }, journeyInstanceId: journeyInstanceId);

    public string CheckAnswers(string oneLoginUserSubject, Guid personId, JourneyInstanceId journeyInstanceId) =>
        linkGenerator.GetRequiredPathByPage("/OneLogins/OneLoginDetail/DisconnectPerson/CheckAnswers",
            routeValues: new { oneLoginUserSubject, personId }, journeyInstanceId: journeyInstanceId);

    public string CheckAnswersCancel(string oneLoginUserSubject, Guid personId, JourneyInstanceId journeyInstanceId) =>
