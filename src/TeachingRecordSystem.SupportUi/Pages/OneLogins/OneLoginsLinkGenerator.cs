...
{
    public string Index(string? search = null, OneLoginSearchSortByOption? sortBy = null, SortDirection? sortDirection = null) =>
        linkGenerator.GetRequiredPathByPage("/OneLogins/Index", routeValues: new { search, sortBy, sortDirection });
