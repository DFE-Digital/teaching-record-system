...
public class GetTeacherByTrnTests : TestBase
{
    ...
    {
        // Arrange
        var request = new HttpRequestMessage(HttpMethod.Get, "/v3/teachers/1234567");
    ...
    public async Task Get_ValidRequestWithPreviousNames_ReturnsExpectedPreviousNamesContent()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/v3/teachers/{person.Trn}?include=PreviousNames");
