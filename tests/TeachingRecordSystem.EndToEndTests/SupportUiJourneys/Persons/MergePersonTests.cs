...
public class MergePersonTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task MergePerson_PersonsMatchOnAllFields()
    {
        ...
        var person2 = await TestData.CreatePersonAsync(p => p
            ...
            .WithDateOfBirth(person1.DateOfBirth!.Value)
        ...
        await page.ClickGovUkButtonAsync("Merge with another record");
        ...
        await page.ClickGovUkButtonAsync("Confirm and update primary record");

        await page.AssertOnPersonDetailPageAsync(person1.PersonId);
        await page.AssertBannerAsync("Success", $"Records merged for {string.JoinNonEmpty(' ', person1.FirstName, person1.MiddleName, person1.LastName)}");
    ...
    public async Task MergePerson_PersonsDifferOnAllFields()
    {
        ...
        await page.ClickRadioByLabelAsync(person2.DateOfBirth!.Value.ToString(WebConstants.DateDisplayFormat));
        ...
        await page.AssertContentEqualsAsync(person2.DateOfBirth!.Value.ToString(WebConstants.DateDisplayFormat), "Date of birth");
    ...
    public async Task MergePerson_CYA_ChangeDetails_ContinuesToCYA(string changeLink)
    {
        ...
        await page.ClickRadioByLabelAsync(person1.DateOfBirth!.Value.ToString(WebConstants.DateDisplayFormat));
        ...
        await page.AssertContentEqualsAsync(person1.DateOfBirth!.Value.ToString(WebConstants.DateDisplayFormat), "Date of birth");
