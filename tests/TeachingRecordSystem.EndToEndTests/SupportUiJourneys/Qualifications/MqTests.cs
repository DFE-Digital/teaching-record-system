...
namespace TeachingRecordSystem.EndToEndTests.SupportUiJourneys.Qualifications;
...
public class MqTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task AddMq()
    {
        ...
        await page.ClickGovUkButtonAsync("Add a mandatory qualification");
        ...
        await page.ClickGovUkButtonAsync("Confirm and add mandatory qualification");
    ...
    public async Task DeleteMq()
    {
        ...
        await page.ClickGovUkButtonAsync("Confirm and delete qualification");
