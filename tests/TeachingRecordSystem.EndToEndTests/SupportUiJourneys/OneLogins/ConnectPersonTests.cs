...
public class ConnectPersonTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task ConnectPerson_Success(bool isVerified)
    {
        ...
        await page.ClickGovUkButtonAsync("Connect to a record");
        ...
        await page.ClickGovUkButtonAsync("Connect record to GOV.UK One Login");
        ...
        await page.ClickGovUkButtonAsync("Confirm and connect");
