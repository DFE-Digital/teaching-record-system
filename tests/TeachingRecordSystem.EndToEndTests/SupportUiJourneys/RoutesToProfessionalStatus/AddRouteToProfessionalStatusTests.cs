...
public class AddRouteToProfessionalStatusTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task Route_AddJourneyToCyaPageAndBack()
    {
        ...
        await page.ClickGovUkButtonAsync("Add a route");

        await page.AssertOnRouteAddRoutePageAsync();
        await page.FillAsync($"label:text-is('Enter the route type')", route.Name);
        ...
        await page.SelectAgeRangeAsync(TrainingAgeSpecialismType.FoundationStage);
        await page.ClickGovUkButtonAsync("Continue");
    ...
    public async Task Route_AddJourney()
    {
        ...
        await page.AssertOnRouteAddRoutePageAsync();
        await page.FillAsync($"label:text-is('Enter the route type')", setRoute.Name);
        await page.FocusAsync("button:text-is('Continue')");
        await page.ClickGovUkButtonAsync("Continue");
        ...
        await page.AssertOnRouteAddAgeRangeAsync();
        await page.SelectAgeRangeAsync(TrainingAgeSpecialismType.KeyStage1);
        await page.ClickGovUkButtonAsync("Continue");
        ...
        await page.AssertOnRouteAddCheckYourAnswersPage();
        await page.ClickGovUkButtonAsync("Confirm and add route");
