...
public class TeacherPensionsSupportTasks(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task MergeRecord()
    {
        ...
        await page.ClickRadioByLabelAsync($"{duplicatePerson1.DateOfBirth!.Value.ToString(WebConstants.DateDisplayFormat, CultureInfo.InvariantCulture)}");
        ...
        await page.ClickGovUkButtonAsync("Confirm and merge records");
        await page.AssertOnTeachersPensionsSupportTasksPageAsync();
