...
public class MatchesTests(HostFixture hostFixture) : ResolveApiTrnRequestTestBase(hostFixture)
{
    ...
    public async Task Get_TaskDoesNotExist_ReturnsNotFound()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/support-tasks/trn-requests/{supportTaskReference}/resolve/matches");
    ...
    public async Task Get_TaskIsClosed_ReturnsNotFound()
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Get, $"/support-tasks/trn-requests/{supportTask.SupportTaskReference}/resolve/matches");
    ...
    public async Task Get_ValidRequest_ShowsRequestDetails()
    {
        // Arrange
        var applicationUser = await TestData.CreateApplicationUserAsync();
        var (supportTask, _, matchedPersonIds) = await TestData.CreateTrnRequestSupportTaskAsync(applicationUser.UserId, s => s
    ...
    public async Task Get_ValidRequest_ShowsDetailsOfMatchedRecords()
    {
        ...
        Assert.Equal(firstMatch.DateOfBirth?.ToString(WebConstants.DateOnlyDisplayFormat), firstMatchDetails.GetSummaryListValueByKey("Date of birth"));
    ...
    public async Task Get_MultipleMatches_ShowsInOrderOfBestMatchFirst()
    {
        ...
        var (supportTask, _, matchedPersonIds) = await TestData.CreateTrnRequestSupportTaskAsync(applicationUser.UserId, configure =>
        {
    ...
    public async Task Get_CreateNewRecordInState_SelectsCreateNewRecordOption()
    {
        ...
        Assert.True(
            doc.GetElementsByName("PersonId")
                .Single(e => e.GetAttribute("value") == ResolveTrnRequestState.CreateNewRecordPersonIdSentinel.ToString())
                .IsChecked());
    }
    ...
    public async Task Get_ShowsRefreshedMatchedPersons()
    {
        ...
        var (supportTask, _, matchedPersonIds) = await TestData.CreateTrnRequestSupportTaskAsync(
    ...
    public async Task Post_CreateNewRecordChosen_UpdatesStateAndRedirects()
    {
        ...
        var personId = ResolveTrnRequestState.CreateNewRecordPersonIdSentinel;
