...
public partial class ChangeHistoryTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task Get_WithPersonImportedIntoDqtProcess_RendersExpectedEntry()
    {
        ...
        doc.AssertHasChangeHistoryEntry(
            ...
            ("National Insurance number", person.NationalInsuranceNumber),
            ("Gender", person.Gender?.GetDisplayName()),
            ("QTS held since", person.QtsDate?.ToString(WebConstants.DateDisplayFormat)),
            ("EYTS held since", person.EytsDate?.ToString(WebConstants.DateDisplayFormat)),
    ...
    public async Task Get_WithPersonUpdatingInDqtProcess_RendersExpectedEntry()
    {
        ...
        doc.AssertHasChangeHistoryEntry(
            ...
            [
                ...
                ("National Insurance number", person.NationalInsuranceNumber),
                ("Gender", person.Gender?.GetDisplayName()),
                ("Date of death", person.Person.DateOfDeath?.ToString(WebConstants.DateDisplayFormat)),
                ("QTS held since", person.QtsDate?.ToString(WebConstants.DateDisplayFormat)),
                ("EYTS held since", person.EytsDate?.ToString(WebConstants.DateDisplayFormat)),
                ("QTLS held since", qtlsDate.ToString(WebConstants.DateDisplayFormat)),
            ...
            [
                ...
                ("Date of birth", @event.OldDetails.DateOfBirth?.ToString(WebConstants.DateDisplayFormat)),
                ...
                ("Date of death", @event.OldDetails.DateOfDeath?.ToString(WebConstants.DateDisplayFormat)),
                ("QTS held since", @event.OldDetails.QtsDate?.ToString(WebConstants.DateDisplayFormat)),
                ("EYTS held since", @event.OldDetails.EytsDate?.ToString(WebConstants.DateDisplayFormat)),
