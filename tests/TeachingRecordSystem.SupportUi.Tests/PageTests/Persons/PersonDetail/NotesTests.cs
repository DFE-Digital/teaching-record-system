...
public class NotesTests(HostFixture hostFixture) : TestBase(hostFixture)
{
    ...
    public async Task Get_NoteWithoutAttachment_ReturnsExpectedContent()
    {
        ...
        Assert.Equal(note.CreatedOn.ToString($"{WebConstants.DateDisplayFormat} 'at' HH:mm"), createdDate.TrimmedText());
    ...
    public async Task Get_MultipleNotes_ReturnsContentInCorrectOrder()
    {
        ...
        Assert.Collection(notes,
            item1 =>
            {
                ...
                Assert.NotNull(createdDate);
                Assert.Equal(note2.CreatedOn.ToString($"{WebConstants.DateDisplayFormat} 'at' HH:mm"), createdDate.TrimmedText());
            ...
            item2 =>
            {
                ...
                Assert.NotNull(createdDate);
                Assert.Equal(note1.CreatedOn.ToString($"{WebConstants.DateDisplayFormat} 'at' HH:mm"), createdDate.TrimmedText());
