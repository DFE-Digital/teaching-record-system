...
public class PersonOneLoginUserDisconnectingTests(HostFixture hostFixture) : ChangeHistoryEntryTestBase(hostFixture)
{
    [Fact]
    public async Task ProcessRendersCorrectly()
    {
        ...
        // Assert
        AssertTitle(entry, "Record manually disconnected from GOV.UK One Login");
    }
