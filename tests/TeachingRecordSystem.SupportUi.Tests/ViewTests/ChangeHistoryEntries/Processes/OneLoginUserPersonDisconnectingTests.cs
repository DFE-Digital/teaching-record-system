...
public class OneLoginUserPersonDisconnectingTests(HostFixture hostFixture) : ChangeHistoryEntryTestBase(hostFixture)
{
    [Fact]
    public async Task ProcessRendersCorrectly()
    {
        ...
        // Assert
        AssertTitle(entry, "GOV.UK One Login manually disconnected from a record");
    }
    ...
    [InlineData("Connected incorrectly", null, "Connected incorrectly")]
    ...
    {
        var newOneLoginUser = EventModels.OneLoginUser.FromModel(oneLoginUser) with { PersonId = null };
