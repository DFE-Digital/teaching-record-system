...
public class PersonOneLoginUserConnectingTests(HostFixture hostFixture) : ChangeHistoryEntryTestBase(hostFixture)
{
    [Fact]
    public async Task ProcessRendersCorrectly()
    {
        ...
        // Assert
        AssertTitle(entry, "Record manually connected to a GOV.UK One Login");
    }
    ...
    [InlineData("The system could not find a match automatically", null, "The system could not find a match automatically")]
